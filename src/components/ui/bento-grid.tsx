            ...
            {items.map((item, index) => (
                <div
                    ...
                    className={cn(
                        ...
                        "border border-[#202024] bg-[#09090B]",
                ...
                >
                    ...
                    <div className="relative flex flex-col space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            <span
                                className={cn(
                                    "text-[10px] font-bold px-2 py-1 rounded-lg backdrop-blur-sm uppercase tracking-wider",
                        ...
                        <div className="flex items-center justify-between mt-2">
                            <div className="flex items-center space-x-2 text-xs text-gray-400">
                                {item.tags?.map((tag, i) => (
                                    <span
                                        key={i}
                                        className="px-2 py-1 rounded-md bg-white/10 backdrop-blur-sm transition-all duration-200 hover:bg-white/20 font-medium"
                                    >
                                        {tag}
                                    </span>
                                ))}
                            </div>
                            <span className="text-xs text-[#10B981] font-semibold opacity-0 group-hover:opacity-100 transition-opacity">
                                {item.cta || "Analyze →"}
                            </span>
                        </div>
                    </div>
